  ...
  private queryWhereHasRecursive(builder: any, whereHases: any) {
    ...
    for (let index = 0; index < whereHases.length; index++) {
      ...
      if (whereHas[1].v) {
        ...
        builder.whereHas(whereHas[0], (subQuery:any) => this.queryWhereHasRecursive(subQuery, Object.entries(whereHas[1])))
      }
    }
  ...
  private querySearchRecursive(builder: any, searches: any) {
    ...
    for (let index = 0; index < searches.length; index++) {
      ...
      if (search[1].v) {
        ...
        builder.orWhereHas(search[0], (subQuery:any ) => this.querySearchRecursive(subQuery, Object.entries(search[1])))
      }
    }
